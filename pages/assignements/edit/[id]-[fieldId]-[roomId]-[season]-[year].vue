...
<template>
	<div class="flex flex-col gap-3">
		...
		<ZodForm @submit="submit">
			<ZodKit type="hidden" name="id" />
			<ZodKit type="hidden" name="roomId" />
			<ZodKit type="hidden" name="fieldId" />
			<ZodKit type="hidden" name="year" />
			<ZodKit type="hidden" name="season" />
			<ZodKit label="Start Date" name="startDate" type="date" data-testid="start-date" />
			<ZodKit label="End Date" name="endDate" type="date" data-testid="end-date" />
			<ZodKit label="Estimated Time" name="estimated_time" type="number" data-testid="estimated-time" />
